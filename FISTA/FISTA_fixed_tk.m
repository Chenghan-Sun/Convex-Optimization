...
%FISTA with fixed step size for solving Lasso Problem 
clear all, clc
...
figure 
plot(1:k,cr)
title('Fixed step FISTA satisfied the termination criteria using epsilon=10^-3');
xlabel('Number of iteration');
ylabel('Termination Criteria');
figure
plot(log(2:k),log(error))
title('Log-log plot of function value error of fixed step FISTA using epsilon=10^-3');
